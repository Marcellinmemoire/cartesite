...
lyr_siterepro_9.set('fieldAliases', {'Nom_Site': 'Nom_Site', 'Nom_Com': 'Nom_Com', 'Nom_Dep': 'Nom_Dep', 'Catégorie': 'Catégorie', 'Nb_Visteur': 'Nb_Visteur', 'Ouverture ': 'Ouverture ', 'G / P': 'G / P', 'Gestion': 'Gestion', 'Lieu': 'Lieu', 'Mention': 'Mention', 'Descript': 'Descript', });
lyr_site_externe_L93_10.set('fieldAliases', {'nom_site': 'Nom site', 'nom_com': ' Commune', 'nom_dep': 'Département ', 'catégorie': 'catégorie', 'nb_visteur': 'Nombre de visiteur à l\'année', 'ouverture': 'ouverture', 'g / p': 'Gratuit / Payant', 'gestion': 'Gestion', 'lieu': 'Nature du Lieu', 'mention': 'Distinction', 'descript': 'Description', });
...
lyr_site_externe_L93_10.set('fieldImages', {'nom_site': 'TextEdit', 'nom_com': 'TextEdit', 'nom_dep': 'TextEdit', 'catégorie': 'TextEdit', 'nb_visteur': 'TextEdit', 'ouverture': 'TextEdit', 'g / p': 'TextEdit', 'gestion': 'TextEdit', 'lieu': 'TextEdit', 'mention': 'TextEdit', 'descript': 'TextEdit', });
...
lyr_siterepro_9.set('fieldLabels', {'Nom_Site': 'no label', 'Nom_Com': 'no label', 'Nom_Dep': 'no label', 'Catégorie': 'no label', 'Nb_Visteur': 'no label', 'Ouverture ': 'no label', 'G / P': 'no label', 'Gestion': 'no label', 'Lieu': 'no label', 'Mention': 'no label', 'Descript': 'no label', });
lyr_site_externe_L93_10.set('fieldLabels', {'nom_site': 'inline label', 'nom_com': 'inline label', 'nom_dep': 'inline label', 'catégorie': 'inline label', 'nb_visteur': 'inline label', 'ouverture': 'inline label', 'g / p': 'inline label', 'gestion': 'inline label', 'lieu': 'inline label', 'mention': 'inline label', 'descript': 'inline label', });
