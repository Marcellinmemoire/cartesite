...
var format_Site5P_8 = new ol.format.GeoJSON();
var features_Site5P_8 = format_Site5P_8.readFeatures(json_Site5P_8, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Site5P_8 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Site5P_8.addFeatures(features_Site5P_8);
var lyr_Site5P_8 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Site5P_8, 
                style: style_Site5P_8,
                interactive: true,
                title: '<img src="styles/legend/Site5P_8.png" /> Site5P'
            });
var format_Brianon_9 = new ol.format.GeoJSON();
var features_Brianon_9 = format_Brianon_9.readFeatures(json_Brianon_9, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Brianon_9 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Brianon_9.addFeatures(features_Brianon_9);
var lyr_Brianon_9 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Brianon_9, 
                style: style_Brianon_9,
                interactive: true,
                title: '<img src="styles/legend/Brianon_9.png" /> Briançon'
            });

lyr_GoogleSatellite_0.setVisible(true);lyr_paca_1.setVisible(true);lyr_FPHAUTEALPE_2.setVisible(true);lyr_fpalpemari_3.setVisible(true);lyr_FPHAUTEPRO_4.setVisible(true);lyr_FPVAR_5.setVisible(true);lyr_fpvaucluse_6.setVisible(true);lyr_FPbr_7.setVisible(true);lyr_Site5P_8.setVisible(true);lyr_Brianon_9.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_paca_1,lyr_FPHAUTEALPE_2,lyr_fpalpemari_3,lyr_FPHAUTEPRO_4,lyr_FPVAR_5,lyr_fpvaucluse_6,lyr_FPbr_7,lyr_Site5P_8,lyr_Brianon_9];
...
lyr_Site5P_8.set('fieldAliases', {'nom_site': 'Nom', 'nom_com': 'Commune', 'nom_dep': 'Département', 'catégorie': 'catégorie', 'nb_visteur': 'Nombre de visiteurs annuelle', 'ouverture': 'ouverture', 'g___p': 'Gratuit / Payant', 'gestion': 'Gestion', 'lieu': 'Nature lieu', 'mention': 'Distinction', 'descript': 'Description', });
lyr_Brianon_9.set('fieldAliases', {'nom_site': 'Nom', 'nom_com': 'Commune', 'nom_dep': 'Département', 'cat�gori': 'Catégorie', 'nb_visteur': 'Nombre de visiteur annuelle', 'ouverture': 'ouverture', 'g___p': 'Gratuit / Payant', 'gestion': 'Gestion', 'lieu': 'Nature du lieu', 'mention': 'Distinction', 'descript': 'Description', });
...
lyr_Site5P_8.set('fieldImages', {'nom_site': 'TextEdit', 'nom_com': 'TextEdit', 'nom_dep': 'TextEdit', 'catégorie': 'TextEdit', 'nb_visteur': 'TextEdit', 'ouverture': 'TextEdit', 'g___p': 'TextEdit', 'gestion': 'TextEdit', 'lieu': 'TextEdit', 'mention': 'TextEdit', 'descript': 'TextEdit', });
lyr_Brianon_9.set('fieldImages', {'nom_site': 'TextEdit', 'nom_com': 'TextEdit', 'nom_dep': 'TextEdit', 'cat�gori': 'TextEdit', 'nb_visteur': 'TextEdit', 'ouverture': 'TextEdit', 'g___p': 'TextEdit', 'gestion': 'TextEdit', 'lieu': 'TextEdit', 'mention': 'TextEdit', 'descript': 'TextEdit', });
...
lyr_Site5P_8.set('fieldLabels', {'nom_site': 'inline label', 'nom_com': 'inline label', 'nom_dep': 'inline label', 'catégorie': 'inline label', 'nb_visteur': 'inline label', 'ouverture': 'inline label', 'g___p': 'inline label', 'gestion': 'inline label', 'lieu': 'inline label', 'mention': 'inline label', 'descript': 'inline label', });
lyr_Brianon_9.set('fieldLabels', {'nom_site': 'inline label', 'nom_com': 'inline label', 'nom_dep': 'inline label', 'cat�gori': 'inline label', 'nb_visteur': 'inline label', 'ouverture': 'inline label', 'g___p': 'inline label', 'gestion': 'inline label', 'lieu': 'inline label', 'mention': 'inline label', 'descript': 'inline label', });
lyr_Brianon_9.on('precompose', function(evt) {
